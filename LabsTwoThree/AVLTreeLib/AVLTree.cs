...
namespace AVLTreeLib
{
    public class AVLTree
    {
        ...
        private AVLNode Insert(AVLNode node, double key)
        {
        ...
        private AVLNode Delete(AVLNode node, double key)
        {
        ...
        private bool Find(AVLNode node, double key)
        {
            if (node == null)
                return false;
        ...
        private static void CloneAndIncreaseKeys(AVLNode source, AVLTree resultTree, double value)
        {
            if (source == null)
                return;

            double newKey = source.Key + value;
